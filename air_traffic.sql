...
(
  ...
  departure TIMESTAMP NOT NULL,
  arrival TIMESTAMP NOT NULL,
  airlineID INTEGER REFERENCES airlines,
  leaving INTEGER REFERENCES cities,
  arriving_at INTEGER REFERENCES cities
);
...
INSERT INTO tickets
  (passengerID, seat, departure, arrival, airlineID, leaving, arriving_at)
VALUES
